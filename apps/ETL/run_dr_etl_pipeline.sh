...
eval python /app/apps/ETL/dr_etl_pipeline.py --env "'$ENV'" --lob "'$LOB'" --statscl-mdl-cd "'$STATSCL_MDL_CD'" $USE_CSV $SNAP_ARG $TRND_ARG $LOB_DESC_ARG --csv-file "'$CSV_FILE'" 
EXIT_CODE=$?
