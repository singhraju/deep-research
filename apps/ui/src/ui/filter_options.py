...
def convert_current_ecap_time_to_previous_year(
    ...
    def shift_to_previous_year(period_value: int) -> int:
    ...
    return shift_to_previous_year(current_period_start), shift_to_previous_year(current_period_end)
...
def _build_period_payload(
    ...
    start_month = get_ecap_start_month(period_code, end_month)
    previous_start, previous_end = convert_current_ecap_time_to_previous_year(start_month, end_month)
...
def build_prebuilt_intent(
    *,
    ...
    if period_label and end_month is not None:
        period_payload = _build_period_payload(period_label, end_month, rolling_window)
